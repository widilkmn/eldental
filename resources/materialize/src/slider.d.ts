...
export declare class Slider extends Component<SliderOptions> {
    ...
    _handleIndicatorClick: (e: MouseEvent) => void;
    _handleAutoPauseHover: () => void;
    _handleAutoPauseFocus: () => void;
    _handleAutoStartHover: () => void;
    _handleAutoStartFocus: () => void;
    _handleInterval: () => void;
    _animateSlide(slide: HTMLElement, isDirectionIn: boolean): void;
    _setSliderHeight(): void;
    _setupIndicators(): void;
    _removeIndicators(): void;
